/* kinetic.jsx — derlenmiş. Kaynağı kök dizinde düzenle, sonra yeniden derle. */
(function(){
...
function KineticText({
  ...
  return /*#__PURE__*/React.createElement("span", {
    ref: rootRef,
    className: "ktext"
  }, words.map((word, wi) => /*#__PURE__*/React.createElement(React.Fragment, {
    key: wi
...
function Reveal({
  ...
  const Tag = as;
  const base = variant === 'fade' ? 'rv-fade' : variant === 'mask' ? 'rv-mask' : variant === 'wire' ? 'rb-wire' : 'rv';
...
function SideNav({
  ...
  const items = view === 'home' ? HOME_SECTIONS.map(s => ({
    key: s.id,
    label: s.label,
    active: active === s.id,
    onClick: () => go(s.id)
