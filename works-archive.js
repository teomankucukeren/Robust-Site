/* works-archive.jsx — derlenmiş. Kaynağı kök dizinde düzenle, sonra yeniden derle. */
(function(){
...
function WorksArchive({
  ...
  const filtered = activeCat === 'ALL' ? ARCHIVE_WORKS : ARCHIVE_WORKS.filter(w => w.cat === activeCat);
  ...
  useEffect(() => {
    window.__rbArchiveList = filtered;
  }, [filtered]);
  const handleCat = cat => {
  ...
  useEffect(() => {
    ...
    if (window.matchMedia('(max-width: 760px)').matches) {
      const mloop = () => {
        ...
        const bottomBlend = maxScroll <= 0 ? 1 : Math.max(0, Math.min(1, (window.scrollY - (maxScroll - endZone)) / endZone));
        for (let i = 0; i < rows.length; i++) {
          ...
          if (wantFocus !== el.__foc) {
            el.__foc = wantFocus;
            el.classList.toggle('is-focus', wantFocus);
          }
        }
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement(window.LangSwitch, null), /*#__PURE__*/React.createElement(CloseBtn, {
    onClick: () => window.RBRouter.back()
  }))), /*#__PURE__*/React.createElement("div", {
    className: "gutter",
    style: {
  ...
  }, rbT('archive.eyebrow', lang)), /*#__PURE__*/React.createElement("span", {
    style: {
      flex: 1
    }
  }), /*#__PURE__*/React.createElement("span", {
  ...
  }, CATS.map(cat => /*#__PURE__*/React.createElement(FilterBtn, {
    key: cat,
    label: rbT('archive.cat.' + cat.toLowerCase(), lang),
    lang: lang === 'TR' ? 'tr' : 'en',
    active: activeCat === cat,
    count: cat === 'ALL' ? ALL_WORKS.length : ALL_WORKS.filter(w => w.cat === cat).length,
    onClick: () => handleCat(cat)
  }))), activeCat === 'DESIGN' ? /*#__PURE__*/React.createElement(DesignMasonry, {
    key: filterKey,
    works: filtered,
    onOpen: openWork
  }) : /*#__PURE__*/React.createElement("div", {
    key: filterKey,
    className: "arch-list"
  }, filtered.map((work, i) => /*#__PURE__*/React.createElement(WorkRow, {
    key: work.id,
    work: work,
    index: i,
    innerRef: el => {
    ...
    onEnter: el => {
      if (canHover) hovRef.current = el;
    },
    onLeave: () => {
      if (canHover) hovRef.current = null;
    },
...
function WorkRow({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      '--spring-delay': `${index * 0.045}s`,
      cursor: 'none'
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "arch-thumb",
    style: {
      backgroundImage: work.thumb || work.cover ? `url(${work.thumb || work.cover})` : `linear-gradient(135deg, ${tintCol} 0%, #0a0a0a 100%)`,
      backgroundPosition: work.thumbPos || 'center'
    }
  }), /*#__PURE__*/React.createElement("span", {
    className: "arch-cat",
    lang: workCatLang(work, lang)
  }, workCat(work, lang)), /*#__PURE__*/React.createElement("div", {
    className: "arch-titlewrap",
    style: {
      position: 'relative',
      zIndex: 1
    }
  }, /*#__PURE__*/React.createElement("h3", {
    className: "display-m arch-title",
    style: {
      fontSize: 'clamp(20px, 2.4vw, 38px)',
      lineHeight: 1.05,
      letterSpacing: '-0.01em'
    }
  }, work.title), /*#__PURE__*/React.createElement("span", {
  ...
  }, work.client)), /*#__PURE__*/React.createElement("div", {
    className: "arch-meta",
    style: {
      position: 'relative',
      zIndex: 1,
  ...
  }, workType(work, lang)), /*#__PURE__*/React.createElement("span", {
    className: "arch-year",
    style: {
...
function FloatingThumb({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      position: 'relative',
      opacity: work.cover ? 0.65 : 1
    }
  }, /*#__PURE__*/React.createElement("circle", {
    cx: "60",
    cy: "60",
    r: "54",
    stroke: "rgba(var(--orange-rgb), 0.3)",
    strokeWidth: "1"
...
function DesignMasonry({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "arch-mason gutter",
    ref: rootRef
  }, items.map((work, i) => /*#__PURE__*/React.createElement("article", {
    key: work.id,
    ...
    className: "arch-mason-frame",
    style: {
      aspectRatio: RATIOS[i % RATIOS.length]
    }
  }, work.cover ? /*#__PURE__*/React.createElement("img", {
    className: "arch-mason-img",
    src: work.thumb || work.cover,
    alt: work.title,
    loading: "lazy",
    style: {
    ...
    className: "arch-mason-grad"
  }), /*#__PURE__*/React.createElement("span", {
    className: "arch-mason-shutter"
  })), /*#__PURE__*/React.createElement("div", {
    className: "arch-mason-meta"
  }, /*#__PURE__*/React.createElement("span", {
    className: "arch-mason-cat",
    lang: work.type ? workTypeLang(work, lang) : workCatLang(work, lang)
  }, work.type ? workType(work, lang) : workCat(work, lang)), /*#__PURE__*/React.createElement("h3", {
    className: "arch-mason-title"
  }, work.title), /*#__PURE__*/React.createElement("span", {
    className: "arch-mason-sub"
  }, work.client, " \xB7 ", work.year)))));
}
