/* works-vitrin.jsx — derlenmiş. Kaynağı kök dizinde düzenle, sonra yeniden derle. */
(function(){
...
const FEATURED_WORKS = [{
  ...
  descTR: 'T-One by Kale için 23 Nisan’a özel hazırlanan bu film; Robust Film prodüksiyonu, WeRabbit ajansı iş birliği ve yönetmen Sinan Akpınar imzası taşıyor.',
  color: '#110500',
  vimeoId: '1193081066',
  ...
  id: 2,
  title: 'Patterns of Possibilities',
  client: 'CANDAŞ ŞİŞMAN',
  type: 'Installation Film',
  typeTR: 'Enstalasyon Filmi',
  year: '2022',
  cat: 'PRODUCTION',
  catTR: 'PRODÜKSİYON',
  production: 'Robust',
  role: 'Video Documentation',
  roleTR: 'Video Dokümantasyonu',
  ...
  descTR: 'Üretken bir enstalasyonun video belgeseli — LED ekran, konstrüksiyon, ses ve ışığın 224 × 224 cm’lik yaşayan bir yüzeyde bir araya geldiği çalışma.',
  color: '#0d0010',
  vimeoId: '1193074497',
  ...
  descTR: 'Özgürlük, hareket ve kişisel tercihin sessiz gücü etrafında kurulan bir moda filmi — ham bir kıyı manzarasına karşı yumuşak bir zarafet.',
  color: '#00060f',
  vimeoId: '1193076670',
  ...
  id: 4,
  title: 'Stone Horizons Vegas',
  client: 'KALE',
  type: '3D Product Film',
  typeTR: '3D Ürün Filmi',
  year: '2026',
  cat: 'ANIMATION',
  catTR: 'ANİMASYON',
  agency: 'WeRabbit',
  ...
  descTR: 'Kale’nin Vegas fuarı için hazırlanan bir 3D ürün filmi — seramik ve porselen levhalar, anıtsal formlar ve mimari kompozisyonlarla ele alındı.',
  color: '#00100a',
  vimeoId: '1193087002',
  ...
  descTR: 'Ürünün yaşam ve ağırlama alanlarına nasıl uyum sağladığını gösteren bir 3D animasyon — mimari görselleştirme, motion design, seslendirme ve ses tasarımı.',
  color: '#0f0800',
  vimeoId: '1193087798',
  ...
  id: 6,
  title: 'EVERYTHING Teaser',
  client: 'NOHLAB',
  type: 'Teaser Edit',
  typeTR: 'Fragman Kurgusu',
  year: '2021',
  cat: 'POST-PRODUCTION',
  catTR: 'POST PRODÜKSİYON',
  editor: 'Teoman Küçükeren',
  ...
  descTR: 'Nohlab’ın sürükleyici deneyimi EVERYTHING için hazırlanan teaser kurgu — her şeyi olduğu gibi gözlemleyip üç bölümde yeni olasılıklar öneriyor.',
  color: '#020a10',
  vimeoId: '1195419528',
  ...
  catTR: 'ANİMASYON',
  agency: 'WeRabbit',
  director: 'Teoman Küçükeren & Sinan Akpınar',
  role: 'Animation',
  roleTR: 'Animasyon',
  desc: 'Direction and motion design for T-One by Kale — animation, edit and sound design by Robust Film.',
  descTR: 'T-One by Kale için yönetmenlik ve motion design — animasyon, kurgu ve ses tasarımı Robust Film imzalı.',
  color: '#100002',
  vimeoId: '1193295771',
  ...
  cat: 'ANIMATION',
  catTR: 'ANİMASYON',
  production: 'Tridea Creative',
  director: 'Recep Akar',
  role: 'VFX & Post Production — Teoman Küçükeren',
  roleTR: 'VFX & Post Prodüksiyon — Teoman Küçükeren',
  ...
  descTR: 'İGA Pass için kesintisiz bir havalimanı yolculuğunu görselleştiren bir marka filmi — canlı çekim, arayüz animasyonu, 3D karakter entegrasyonu ve VFX destekli dijital etkileşimler.',
  color: '#050505',
  vimeoId: '1193312374',
  ...
  agency: 'WeRabbit',
  director: 'Sinan Akpınar',
  role: '3D Animation & Assets',
  roleTR: '3D Animasyon & Asset',
  ...
  agency: 'theWerabbit',
  director: 'Sinan Akpınar',
  role: 'DoP: Teoman Küçükeren',
  roleTR: 'Görüntü Yönetmeni: Teoman Küçükeren',
  ...
  typeTR: 'Dijital Billboard Filmi',
  year: '2026',
  cat: 'ANIMATION',
  catTR: 'ANİMASYON',
  agency: 'Koop',
  role: 'Animation & Post-Production — Teoman Küçükeren',
  roleTR: 'Animasyon & Post Prodüksiyon — Teoman Küçükeren',
  ...
  id: 16,
  title: 'Çağdaş Sanata Yeni Bakış Açıları',
  client: 'EMBASSY OF ITALY',
  type: 'Panel Film',
  typeTR: 'Panel Filmi',
  year: '2024',
  cat: 'PRODUCTION',
  ...
  id: 17,
  title: 'Kalesinterflex: Back in Bologna',
  client: 'KALE',
  type: 'VFX & Product Film',
  typeTR: 'VFX & Ürün Filmi',
  year: '2024',
  cat: 'ANIMATION',
  catTR: 'ANİMASYON',
  agency: 'WeRabbit',
  role: 'VFX & Animation — Sinan Akpınar',
  roleTR: 'VFX & Animasyon — Sinan Akpınar',
  ...
  id: 13,
  title: 'Van Gogh: An Immersive Journey',
  client: 'NOHLAB',
  type: 'Teaser Edit',
  typeTR: 'Fragman Kurgusu',
  year: '2023',
  cat: 'POST-PRODUCTION',
  catTR: 'POST PRODÜKSİYON',
  director: 'Nohlab — Candaş Şişman & Deniz Kader',
  editor: 'Teoman Küçükeren',
  ...
  cat: 'PRODUCTION',
  catTR: 'PRODÜKSİYON',
  director: 'Sinan Akpınar & Teoman Küçükeren',
  role: 'Video & Documentation',
  roleTR: 'Video & Dokümantasyon',
  ...
  id: 18,
  title: 'Bang & Olufsen: Competition Film',
  client: 'BANG & OLUFSEN',
  type: '3D Product Animation',
  typeTR: '3D Ürün Animasyonu',
  year: '2022',
  cat: 'ANIMATION',
  catTR: 'ANİMASYON',
  role: 'Animation',
  ...
  id: 19,
  title: 'Maurer: 1915 Çanakkale Bridge',
  client: 'MAURER',
  type: 'Corporate Film',
  typeTR: 'Kurumsal Film',
  year: '2021',
  ...
  production: 'Tridea Creative',
  director: 'Recep Akar',
  role: 'Editing, Motion Graphics & Sound Design — Teoman Küçükeren',
  roleTR: 'Kurgu, Motion Graphics & Ses Tasarımı — Teoman Küçükeren',
  ...
  id: 20,
  title: 'Delux Tiny House',
  client: 'DELUX TINY HOUSE',
  type: 'CGI Brand Film',
  typeTR: 'CGI Marka Filmi',
  year: '2021',
  cat: 'ANIMATION',
  catTR: 'ANİMASYON',
  role: 'CGI, Concept & Creative Direction — Sinan Akpınar',
  roleTR: 'CGI, Konsept & Kreatif Yönetim — Sinan Akpınar',
  ...
  production: 'Tridea Creative',
  director: 'Recep Akar',
  role: 'Post-Production · Visual Animations & Sound Design — Teoman Küçükeren',
  roleTR: 'Post Prodüksiyon · Görsel Animasyonlar & Ses Tasarımı — Teoman Küçükeren',
  ...
  typeTR: 'Ürün Animasyonu',
  year: '2022',
  cat: 'ANIMATION',
  catTR: 'ANİMASYON',
  role: 'Animation & Post-Production — Sinan Akpınar',
  roleTR: 'Animasyon & Post Prodüksiyon — Sinan Akpınar',
  ...
  id: 23,
  title: 'Uzungöl Metal: Form in Motion',
  client: 'UZUNGÖL METAL',
  type: 'CGI Product Film',
  typeTR: 'CGI Ürün Filmi',
  year: '2022',
  cat: 'ANIMATION',
  catTR: 'ANİMASYON',
  role: 'CGI & Animation — Sinan Akpınar',
  roleTR: 'CGI & Animasyon — Sinan Akpınar',
  ...
  client: '40GECE',
  type: 'Music Video',
  typeTR: 'Müzik Videosu',
  year: '2020',
  cat: 'PRODUCTION',
  catTR: 'PRODÜKSİYON',
  production: 'Robust',
  director: 'Sinan Akpınar & Anıl Basat',
  ...
  id: 26,
  title: 'Haf Stone: Surfaces of Luxury',
  client: 'HAF STONE',
  type: '3D Animation',
  typeTR: '3D Animasyon',
  year: '2023',
  ...
  catTR: 'ANİMASYON',
  production: 'Robust',
  role: '3D Animation · Motion Design · Sound Design — Teoman Küçükeren & Sinan Akpınar',
  roleTR: '3D Animasyon · Motion Design · Ses Tasarımı — Teoman Küçükeren & Sinan Akpınar',
  ...
  id: 28,
  title: 'SGIA: New Terminal Competition',
  client: 'ARUP',
  type: 'Competition Film',
  typeTR: 'Yarışma Filmi',
  year: '2019',
  cat: 'POST-PRODUCTION',
  catTR: 'POST PRODÜKSİYON',
  role: 'Editing & Motion Graphics · Viz: Allza',
  roleTR: 'Kurgu & Motion Graphics · Viz: Allza',
  ...
  id: 29,
  title: 'Paradiso Palms',
  client: 'Paradiso Palms',
  type: 'Visual Identity',
  typeTR: 'Görsel Kimlik',
  year: '2023',
  cat: 'DESIGN',
  catTR: 'TASARIM',
  kind: 'design',
  role: 'Brand & Art Direction',
  roleTR: 'Marka & Art Direction',
  designer: 'Elif Güney',
  ...
  descTR: 'Paradiso Palms için görsel kimlik ve art direction — tatların, seslerin ve anların güneşli bir marka dünyası, cennet-vahası havasında kurgulandı.',
  ...
  aboutTR: 'Paradiso Palms için geliştirilen görsel kimlik; kokteyl kültürünü, iyi yemeği ve bir arada olmanın keyfini sıcak ve davetkar bir atmosferde buluşturuyor. Kadeh formundan yükselen palmiye detayını yalın ve akılda kalıcı bir amblemine dönüştüren logo tasarımı, markanın neşeli ve çabasız karakterini yansıtıyor.\n\nRenk paleti, illustratif detaylar ve grafik sistem; mekanın enerjisini gündüzden geceye samimi, canlı ve özgün bir görsel dille taşıyor. Menülerden bardak altlıklarına, sosyal medyadan basılı materyallere uzanan bütüncül bir tasarım yaklaşımıyla Paradiso Palms; dostlukların, sohbetlerin ve lezzetin kesiştiği benzersiz bir deneyim alanı olarak konumlanıyor.',
  color: '#0d0d00',
  caseBg: '#efd9c2',
  caseFg: '#221208',
  stacked: true,
  ...
  thumbPos: 'center top',
  gallery: ['https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS1.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS2.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS3.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS4.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS5.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS6.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS7.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS8.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS9.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS10.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS11.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS12.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS13.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS14.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/PALMS15.jpg']
}, {
  id: 30,
  title: 'İtalyan Kültür Merkezi',
  client: 'İtalyan Kültür',
  type: 'Social Media Design',
  typeTR: 'Sosyal Medya Tasarımı',
  year: '2023',
  cat: 'DESIGN',
  catTR: 'TASARIM',
  kind: 'design',
  role: 'Social Media & Art Direction',
  roleTR: 'Sosyal Medya & Art Direction',
  designer: 'Elif Güney',
  ...
  gallery: ['https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/01-IT.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/02-IT.jpg', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/03-IT.jpg']
}, {
  id: 31,
  title: 'Işık 1885 Lokali',
  client: 'IŞIK 1885',
  type: 'Corporate Identity',
  typeTR: 'Kurumsal Kimlik',
  year: '2022',
  cat: 'DESIGN',
  catTR: 'TASARIM',
  kind: 'design',
  role: 'Identity & Art Direction',
  roleTR: 'Kimlik & Art Direction',
  designer: 'Elif Güney',
  ...
  aboutTR: 'Işık 1885 Lokali, Işık Üniversitesi sosyal tesisleri için kurgulanan bir mekânsal kimlik projesidir. Yapı; üst katta bir toplantı salonu, giriş katında restoran ve alt katta yarı olimpik yüzme havuzu olmak üzere üç ana alandan oluşuyor.\n\nLogotip tasarımında mimarinin çatı grid’lerinden ve merdiven akslarından beslenerek, bu üç farklı işlevi tek bir kurumsal kimlik çatısı altında bütüncül bir dille bir araya getirdik.',
  color: '#0d0d00',
  caseBg: '#29288b',
  caseFg: '#ffffff',
  ...
  gallery: ['https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK1.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK2.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK3.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK4.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK5.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK6.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK7.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK8.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK9.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK10.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/ISIK11.png']
}, {
  id: 32,
  title: 'Pepsi × Tokyo 2020',
  client: 'PEPSI × TOKYO 2020',
  type: 'Key Visual · Collectible Series',
  typeTR: 'Ana Görsel · Koleksiyonluk Seri',
  year: '2021',
  cat: 'DESIGN',
  catTR: 'TASARIM',
  kind: 'design',
  role: 'Key Visual & Art Direction',
  roleTR: 'Ana Görsel & Art Direction',
  designer: 'Elif Güney',
  ...
  descTR: 'Pepsi x Tokyo 2020 için hazırlanan bu sınırlı seri, Olimpiyat ruhunu Japon kültürünün görsel mirasıyla birleştiriyor.',
  ...
  aboutTR: 'Pepsi x Tokyo 2020 için tasarlanan bu özel seri, Olimpiyat ruhunu Japon kültürünün zengin görsel mirasıyla buluşturuyor. Ejderha efsanelerinden, mitolojik anlatılardan ve Tokyo’nun çağdaş enerjisinden ilham alan tasarım dili, her sporcuyu içindeki gücü açığa çıkaran bir kahramana dönüştürüyor.\n\nEjderha sadece bir sembol olmanın ötesine geçerek; odak, cesaret, hız ve zarafetin görünmez gücüyle her disipline kendi görsel hikayesinde rehberlik ediyor. Pepsi’nin canlı renk paleti, dinamik fırça darbeleri ve Japon estetiğinden beslenen detaylarla birleşen seri; markanın “For the Love of It” ruhunu güçlü, koleksiyonluk ve modern bir Olimpiyat anlatısına dönüştürüyor.',
  color: '#0d0d00',
  ...
  thumbPos: 'center top',
  gallery: ['https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/01.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/02.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/03.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/04.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/05.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/06.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/07.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/08.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/09.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/010.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/011.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/012.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/013.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/014.png', 'https://cdn.jsdelivr.net/gh/teomankucukeren/Robust-Design-G-rseller@main/015.png']
}];
...
// still-English words.
function workCat(work, lang) {
  return lang === 'TR' && work.catTR ? work.catTR : work.cat;
}
function workCatLang(work, lang) {
  return lang === 'TR' && work.catTR ? 'tr' : 'en';
}
function workType(work, lang) {
  return lang === 'TR' && work.typeTR ? work.typeTR : work.type;
}
function workTypeLang(work, lang) {
  return lang === 'TR' && work.typeTR ? 'tr' : 'en';
}
function workDesc(work, lang) {
  return lang === 'TR' && work.descTR ? work.descTR : work.desc;
}
function workDescLang(work, lang) {
  return lang === 'TR' && work.descTR ? 'tr' : 'en';
}
function workRole(work, lang) {
  return lang === 'TR' && work.roleTR ? work.roleTR : work.role;
}
function workRoleLang(work, lang) {
  return lang === 'TR' && work.roleTR ? 'tr' : 'en';
}
...
function WorksVitrin({
  ...
  const openWork = w => window.RBRouter.openProject(w, {
    base: 'home'
  });
  let scene;
  if (isMobile) scene = /*#__PURE__*/React.createElement(MobileWorks, {
    works: SELECTED_WORKS,
    onOpen: openWork,
    setView: setView
  });else if (isTablet) scene = /*#__PURE__*/React.createElement(TabletWorks, {
    works: SELECTED_WORKS_FULL,
    onOpen: openWork,
    setView: setView
  });else scene = /*#__PURE__*/React.createElement(WorksFunnel, {
    works: SELECTED_WORKS_FULL,
    onOpen: openWork,
    setView: setView
  });
...
function MobileWorks({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "mworks gutter shell"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mworks-head"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Reveal, {
    variant: "fade"
  }, /*#__PURE__*/React.createElement("span", {
    className: "eyebrow"
  }, "02")), /*#__PURE__*/React.createElement(Reveal, {
    variant: "mask",
    delay: 0.1,
    style: {
      marginTop: '12px'
    ...
    text: rbT('works.title', lang)
  })))), /*#__PURE__*/React.createElement(Reveal, {
    variant: "fade",
    delay: 0.2
  }, /*#__PURE__*/React.createElement(ViewAllBtn, {
    onClick: () => setView('works')
  }))), /*#__PURE__*/React.createElement("div", {
    className: "mworks-list",
    ref: listRef
  }, works.map((w, i) => /*#__PURE__*/React.createElement(Reveal, {
    key: w.id,
    variant: "fade",
    ...
    className: "mwork-info"
  }, /*#__PURE__*/React.createElement("span", {
    className: "mwork-cat",
    lang: workCatLang(w, lang)
  }, workCat(w, lang)), /*#__PURE__*/React.createElement("h3", {
    className: "mwork-title"
  }, w.title), /*#__PURE__*/React.createElement("p", {
    className: "mwork-client"
  }, /*#__PURE__*/React.createElement("span", {
    lang: "en"
  }, w.client), " \u2014 ", /*#__PURE__*/React.createElement("span", {
    lang: workTypeLang(w, lang)
  }, workType(w, lang)))))))));
}
...
function TabletWorks({
  ...
  const onUp = () => {
    ...
    if (!s.moved) {
      ...
      if (s.d === 0) onOpen(works[am]);else if (s.d != null) setActive(active + s.d);
      setDrag(0);
      setDragging(false);
    ...
    let na = active;
    if (dx < -STEP * 0.22) na = active + 1;else if (dx > STEP * 0.22) na = active - 1;
    setActive(na);
    setDrag(0);
    setDragging(false);
    startRef.current = null;
  ...
  const cardClick = (i, d) => {
    ...
    if (d === 0) onOpen(works[i]);else setActive(active + d);
  };
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "gutter shell vitrin-head fn-head"
  }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Reveal, {
    variant: "fade"
  }, /*#__PURE__*/React.createElement("span", {
    className: "eyebrow"
    ...
    className: "fn-stage gutter"
  }, /*#__PURE__*/React.createElement("div", {
    className: "fn-text"
  }, /*#__PURE__*/React.createElement("div", {
    className: "fn-text-inner"
  }, /*#__PURE__*/React.createElement("span", {
    lang: workCatLang(w, lang),
    style: {
    ...
    lang: workTypeLang(w, lang)
  }, workType(w, lang))), /*#__PURE__*/React.createElement("p", {
    className: "body-text",
    lang: workDescLang(w, lang),
    style: {
      marginTop: '22px',
      maxWidth: '400px',
      lineHeight: 1.7
    }
  }, workDesc(w, lang))), /*#__PURE__*/React.createElement("div", {
    className: "fn-meter"
  }, /*#__PURE__*/React.createElement("span", {
    className: "mono-note",
    style: {
  ...
  }, String(am + 1).padStart(2, '0')), /*#__PURE__*/React.createElement("div", {
    className: "fn-bar"
  }, /*#__PURE__*/React.createElement("div", {
    className: "fn-bar-fill",
    style: {
      transform: `scaleX(${N > 1 ? am / (N - 1) : 0})`
    }
  })), /*#__PURE__*/React.createElement("span", {
    className: "mono-note"
    ...
    }, wk.cover && /*#__PURE__*/React.createElement("div", {
      className: "tw-cover",
      style: {
        backgroundImage: `url(${wk.cover})`
      }
    }));
  }))))));
}
...
function WorksFunnel({
    ...
    const loop = () => {
      ...
      if (track) {
        ...
        works.forEach((w, i) => {
          ...
          const ha = hovAmts.current[i] += ((hovRef.current === i ? 1 : 0) - hovAmts.current[i]) * 0.1;
          ...
          el.style.transform = `translate(-50%, -50%) translate3d(${x.toFixed(1)}px, ${y.toFixed(1)}px, ${z.toFixed(1)}px) ` + `rotateY(${ry.toFixed(2)}deg) scale(${sc.toFixed(3)})`;
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `fn-text-inner${textVis ? '' : ' is-out'}`
  }, /*#__PURE__*/React.createElement("span", {
    lang: workCatLang(w, lang),
    style: {
      fontFamily: "'Space Mono', monospace",
  ...
  }, String(shown + 1).padStart(2, '0')), /*#__PURE__*/React.createElement("div", {
    className: "fn-bar"
  }, /*#__PURE__*/React.createElement("div", {
    ref: barRef,
    className: "fn-bar-fill"
    ...
    className: "fn-scene",
    ref: sceneRef
  }, works.map((work, i) => /*#__PURE__*/React.createElement(FunnelCard, {
    key: work.id,
    work: work,
    isFront: i === active,
    isHov: hovIdx === i,
...
function FunnelCard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      borderColor: isHov ? 'rgba(var(--orange-rgb), 0.55)' : isFront ? 'rgba(var(--orange-rgb), 0.35)' : 'rgba(255,255,255,0.07)',
      boxShadow: isHov ? '0 0 18px rgba(var(--orange-rgb), 0.32), 0 0 56px rgba(var(--orange-rgb), 0.16)' : isFront ? '0 0 14px rgba(var(--orange-rgb), 0.22), 0 0 44px rgba(var(--orange-rgb), 0.1)' : 'none',
      transition: 'border-color 0.4s ease, box-shadow 0.6s ease',
      cursor: 'none'
    }
  }, work.cover && /*#__PURE__*/React.createElement("div", {
    className: "fn-cover",
    style: {
    ...
    cy: "60",
    r: "56",
    stroke: "rgba(var(--orange-rgb), 0.4)",
    strokeWidth: "1"
  }), /*#__PURE__*/React.createElement("circle", {
    cx: "60",
    cy: "60",
    ...
    d: "M50 42l32 18-32 18V42z",
    fill: "var(--orange)",
    opacity: "0.85"
  }))), !work.cover && /*#__PURE__*/React.createElement("svg", {
    style: {
      position: 'absolute',
      inset: 0,
      width: '100%',
  ...
  }, work.year), isHov && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
      inset: 0,
      pointerEvents: 'none',
...
function ViewAllBtn({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    lang: lang === 'TR' ? 'tr' : 'en'
  }, rbT('works.viewAll', lang)), /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
...
function WorkOverlay({
  ...
  // False until the film actually paints its first frame. Until then a poster
  // layer (the work's own key art) covers the iframe — Vimeo's own document is
  // white while it boots, which flashed between films.
  ...
  // The work this overlay was originally opened with. Anything else means the
  // viewer arrived here via prev/next, so entrance fades must be skipped —
  // otherwise the page underneath shows through for the duration of the fade.
  const openedWithRef = useRef(work.id);
  ...
  useLayoutEffect(() => {
    ...
    const onGesture = e => {
      ...
      if (e && e.type === 'keydown' && ['ArrowRight', 'ArrowLeft', 'ArrowUp', 'ArrowDown', 'Escape'].includes(e.key)) return;
      // Clicks/taps on the prev/next arrows or the close control likewise must
      // never unmute the outgoing film.
      if (e && (e.type === 'pointerdown' || e.type === 'touchstart') && e.target && e.target.closest && e.target.closest('[data-no-unmute]')) return;
      unmute();
    };
    try {
      ...
      // Reveal the film only once it is really rendering frames.
      const reveal = () => {
  ...
  useEffect(() => {
    ...
    if (window.__rbBgReel) {
      try {
        window.__rbBgReel.pause();
      } catch (e) {}
    }
    return () => {
      clearTimeout(id);
  ...
  if (work.gallery && work.gallery.length && window.ProjectCase) {
    ...
    return /*#__PURE__*/React.createElement(PC, {
      work: work,
      onClose: onClose,
      onNav: onChange ? go : null,
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, rbT('pcase.close', lang)), /*#__PURE__*/React.createElement("div", {
    onClick: e => e.stopPropagation(),
    style: {
      width: isMobile ? '100%' : 'min(97vw, 1760px)',
      ...
      maxWidth: isMobile ? '100%' : 'calc((100svh - 240px) * 1.7778 + clamp(140px, 14vw, 208px))',
  ...
  }, onChange && !isMobile && /*#__PURE__*/React.createElement(OverlayNavBtn, {
    glyph: "\u21BC",
    title: rbT('overlay.prevFilm', lang),
    side: "left",
    onClick: () => go(-1)
  }), onChange && !isMobile && /*#__PURE__*/React.createElement(OverlayNavBtn, {
    glyph: "\u21C0",
    title: rbT('overlay.nextFilm', lang),
    side: "right",
    onClick: () => go(1)
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, work.vimeoId ? /*#__PURE__*/React.createElement("iframe", {
    key: work.vimeoId,
    ref: vimeoRef,
    className: "wo-video",
    ...
    l: rbT('credit.project', lang),
    v: work.title
  }, {
    l: rbT('pcase.client', lang),
    v: work.client
  }, {
    l: rbT('credit.type', lang),
    v: workType(work, lang)
  }, {
    l: rbT('pcase.year', lang),
    v: work.year
  }, work.production && {
    l: rbT('credit.production', lang),
    v: work.production
  }, work.agency && {
    l: rbT('credit.agency', lang),
    v: work.agency
  }, work.director && {
    l: rbT('credit.director', lang),
    v: work.director
  }, work.dop && {
    l: rbT('credit.dop', lang),
    v: work.dop
  }, work.editor && {
    l: rbT('credit.editor', lang),
    v: work.editor
  }, ...(work.credits || []).map(c => ({
    l: c.role,
    v: c.name
  ...
  }, v)))), links && links.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
  ...
  }, links.map(lk => /*#__PURE__*/React.createElement(OverlayLink, {
    key: lk.label,
    label: lk.label,
    onClick: lk.onClick
  }))), isMobile && onChange && !work.gallery && /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      justifyContent: 'center',
      alignItems: 'center',
...
function EndScreen({
  ...
  useEffect(() => {
    if (paused) return;
    setBar(100);
    const raf = requestAnimationFrame(() => requestAnimationFrame(() => setBar(0)));
    let c = DURATION;
    setCount(c);
  ...
  }, /*#__PURE__*/React.createElement("style", null, `@keyframes esFade{from{opacity:0}to{opacity:1}}`), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'baseline',
  ...
  }, "\u21BA"), " ", rbT('overlay.replay', lang)), /*#__PURE__*/React.createElement("span", {
    lang: "en",
    style: {
      ...label,
      textAlign: 'right',
  ...
  }, count, lang === 'TR' ? ' sn' : 's'))), /*#__PURE__*/React.createElement("div", {
    style: {
      height: '2px',
  ...
  }, ups.map((w, i) => /*#__PURE__*/React.createElement(EndThumb, {
    key: w.id,
    work: w,
    isNext: i === 0,
    onPick: onPick
...
function EndThumb({
  ...
  }, work.title), work.client ? /*#__PURE__*/React.createElement("div", {
    lang: "en",
    style: {
      marginTop: '5px',
      fontFamily: "'Space Grotesk'",
  ...
  }, work.client) : null, work.cat ? /*#__PURE__*/React.createElement("div", {
    lang: workCatLang(work, lang),
    style: {
      marginTop: '5px',
      fontFamily: "'Space Grotesk'",
      fontSize: '15px',
  ...
  }, workCat(work, lang)) : null);
}
function OverlayNavBtn({
  glyph,
  title,
  side,
  onClick
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      textShadow: hov ? '0 0 22px rgba(var(--orange-rgb), 1), 0 0 60px rgba(var(--orange-rgb), 0.5)' : 'none',
      zIndex: 10,
      userSelect: 'none'
    }
  }, glyph);
...
function DesignShowcase({
  ...
  return /*#__PURE__*/React.createElement("a", {
    ...
    style: {
      ...
      cursor: 'none',
      overflow: 'hidden',
      background: work.cover ? `#060606` : `repeating-linear-gradient(135deg, #0f0f08 0px, #0f0f08 12px, #0b0b06 12px, #0b0b06 24px)`
    }
  }, work.cover && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
  ...
  }), !work.cover && /*#__PURE__*/React.createElement("span", {
    style: {
      position: 'absolute',
      top: '18px',
      left: '20px',
  ...
  }, "cover image \u2014 drop here"), /*#__PURE__*/React.createElement("span", {
    style: {
      position: 'relative',
      zIndex: 2,
      display: 'inline-flex',
  ...
  }, "View on Behance", /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--orange)',
      fontSize: '0.82em'
    }
